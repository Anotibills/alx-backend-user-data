...
class BasicAuth(Auth):
    '''
    The basic authorization class
    '''

    def extract_base64_authorization_header(self,
                                            authorization_header: str) -> str:
        '''
        This returns the Base64 part of the Authorization header
        '''
    ...
    def extract_user_credentials(self,
        ...
        '''
        This returns the user email and password from the Base64 decoded value
        '''
    ...
    def user_object_from_credentials(self,
        ...
        '''
        This returns the User instance based on email and password
        '''
    ...
    def current_user(self, request=None) -> TypeVar('User'):
        '''
        This overloads Auth and retrieves the User instance for a request
        '''
        try:
